...
## ChemSmart Studio workflow (READ FIRST — overrides packaging / install steps below)

You are running inside ChemSmart Studio. Skills live in a managed global registry,
