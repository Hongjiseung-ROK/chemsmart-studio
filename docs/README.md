...
| [ChemSmart Studio Agent Tool Surface](./references/chemsmart-studio-agent-tool-surface.md) | Phase exposure, one-shot execution approvals, and deliberately withheld tools |
