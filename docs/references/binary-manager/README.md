...
> **No v1→v2 migrator.** The v2 pref key (`feature.binary.tools`) has no predecessor in v1, so there is intentionally nothing to migrate. See the [development guide](../../guides/development.md) for the current data-layer policy.
