...
describe('isAllowedAssistantNavigationPath', () => {
  it('allows only the Studio workspace and settings routes', () => {
    expect(isAllowedAssistantNavigationPath('/app/chemsmart')).toBe(true)
    expect(isAllowedAssistantNavigationPath('/app/chemsmart/project-1')).toBe(true)
  ...
  it('blocks removed routes and prefix lookalikes', () => {
    ...
    expect(isAllowedAssistantNavigationPath('/app/agents')).toBe(false)
    expect(isAllowedAssistantNavigationPath('/app/mini-app/example')).toBe(false)
    expect(isAllowedAssistantNavigationPath('/app/chat')).toBe(false)
