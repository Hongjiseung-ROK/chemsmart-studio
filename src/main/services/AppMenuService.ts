...
const repositoryUrl = 'https://github.com/Hongjiseung-ROK/chemsmart-studio'
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            click: () => {
              void shell.openExternal(`${repositoryUrl}#readme`)
            }
          },
          {
            type: 'custom',
            ...
            click: () => {
              void shell.openExternal(`${repositoryUrl}/issues/new`)
            }
          },
          {
            type: 'custom',
            ...
            click: () => {
              void shell.openExternal(`${repositoryUrl}/releases`)
            }
          }
        ]
      }
