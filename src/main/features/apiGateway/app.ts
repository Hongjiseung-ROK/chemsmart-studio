  ...
  const app = new Elysia({ adapter: node() })
    ...
    .use(
      openapi({
        ...
        documentation: {
          info: {
            title: 'ChemSmart Studio API',
            version: '1.0.0',
            description:
              'OpenAI- and Anthropic-compatible HTTP API for ChemSmart Studio, plus ChemSmart-specific endpoints (models, knowledge bases)'
          }
        }
      })
    )
