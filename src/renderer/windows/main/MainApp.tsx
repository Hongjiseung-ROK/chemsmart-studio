...
//
// useStorageMonitorNotification / useTopicNamingErrorNotification are intentionally
// main-only (their toasts must not duplicate across windows) and intentionally React hooks:
