...
export const zhCN = {
  ...
  migration: {
    ...
    introduction: {
      title: '将数据迁移到新的架构中',
      subtitle: 'ChemSmart Studio V2 · 全新数据架构',
      features: {
        architecture: {
          title: '全新数据架构',
    ...
    completed: {
      title: '欢迎来到 ChemSmart Studio V2',
    ...
    version_incompatible: {
      title: '版本升级提示',
      preamble: 'ChemSmart Studio 对数据存储进行了重大重构，为了保证旧数据的安全迁移，我们对升级顺序有严格要求。',
      no_version_log:
...
export const enUS = {
  ...
  migration: {
    ...
    introduction: {
      ...
      subtitle: 'ChemSmart Studio V2 · New Data Architecture',
      features: {
        architecture: {
    ...
    completed: {
      title: 'Welcome to ChemSmart Studio V2',
    ...
    version_incompatible: {
      ...
      preamble:
        'ChemSmart Studio has undergone a major data storage refactoring. To ensure safe migration of your data, we have strict requirements on the upgrade order.',
      no_version_log:
