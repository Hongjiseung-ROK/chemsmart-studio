...
describe('ThemeProvider first frame', () => {
  ...
  it('preserves an explicitly saved light theme when the fresh-profile default is dark', () => {
    MockUsePreferenceUtils.setPreferenceValue('ui.theme_mode', ThemeMode.light)
