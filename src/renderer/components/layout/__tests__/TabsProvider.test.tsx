...
vi.mock('@renderer/utils/routeTitle', async () => {
  ...
  const titles: Record<string, Record<string, string>> = {
    ...
    '/app/chemsmart': { en: 'ChemSmart Studio', zh: 'ChemSmart Studio' },
...
describe('TabsProvider', () => {
  it('opens ChemSmart Studio as the default primary workspace', () => {
    render(
    ...
    expect(screen.getByTestId('tab-urls')).toHaveTextContent('/app/chemsmart')
  ...
  it('opens ChemSmart Studio when closing the only tab', async () => {
    render(
      <TabsProvider
        initialDefaultTab={{
          id: 'home',
    ...
    await waitFor(() => expect(screen.getByTestId('tab-urls')).toHaveTextContent('/app/chemsmart'))
    expect(screen.getByTestId('tab-titles')).toHaveTextContent('ChemSmart Studio')
