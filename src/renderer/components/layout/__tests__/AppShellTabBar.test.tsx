...
describe('AppShellTabBar', () => {
  ...
  it('keeps nested visual close icons out of the keyboard and button accessibility trees', () => {
    renderTabBar()

    expect(
      screen.getByTestId('app-shell-tab-strip').querySelectorAll('[data-tab-id] div[role="button"][tabindex="0"]')
    ).toHaveLength(0)
  })
