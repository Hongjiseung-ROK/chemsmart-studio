...
export type RendererPersistCacheSchema = {
  ...
  // ChemSmart Studio dock geometry, keyed by panel id to flex-grow. Null means no user layout has been
  ...
  // Commands the researcher ran in the Studio console, newest first. Convenience only; losing it costs
  // nothing but retyping.
  'ui.studio.console.history': string[]
}
