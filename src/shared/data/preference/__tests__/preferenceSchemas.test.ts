...
describe('DefaultPreferences', () => {
  ...
  it('defaults fresh profiles to the dark research workspace without overriding saved preferences', () => {
    const themeDefault: PreferenceSchemas['default']['ui.theme_mode'] = ThemeMode.dark

    expect(DefaultPreferences.default['ui.theme_mode']).toBe(themeDefault)
  })
