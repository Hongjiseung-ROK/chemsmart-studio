...
/** Imperative handle for collapsing, expanding, and resizing a {@link ResizablePanel} from outside. */
type ResizablePanelHandle = ResizablePrimitive.PanelImperativeHandle

/** Creates the ref passed to {@link ResizablePanel} via `panelRef` for imperative collapse/expand. */
...
export type { ResizableHandleProps, ResizablePanelGroupProps, ResizablePanelHandle, ResizablePanelProps }
