...
Bundled AI provider and model catalog for ChemSmart Studio: static JSON data files plus TypeScript schemas for reading them.
...
> **Contributing?** The `data/*.json` files are **generated** — never hand-edit them. Edit `src/creators/` / `src/providers/`, run `pnpm generate`, and review [docs/architecture.md](docs/architecture.md).
