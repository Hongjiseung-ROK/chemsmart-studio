...
// schema-sha256: 046b707ba3e72fcb7b1a1b0004ebf53a435bdb4f6ffd3345ab9dd4e79225d92e
...
export const SCHEMA_SHA256 = '046b707ba3e72fcb7b1a1b0004ebf53a435bdb4f6ffd3345ab9dd4e79225d92e' as const
export const CHEMSMART_COMMIT = 'cf986251077b7ee65f8afa951ee76052146c7613' as const
...
export const studioAgentWorkbenchRuntimeSchema = {
  ...
  "oneOf": [
    ...
    {
      "$ref": "#/$defs/studioAgentRunReceipt"
    },
    {
...
export const projectWorkspaceRuntimeSchema = {
  ...
  "anyOf": [
    ...
    {
      "$ref": "#/$defs/registerCandidateRequest"
    },
    {
      "$ref": "#/$defs/candidateSummary"
    },
    {
      "$ref": "#/$defs/candidateQueryRequest"
    },
    {
      "$ref": "#/$defs/candidateResult"
    },
    {
      "$ref": "#/$defs/candidateDecisionRequest"
    },
    {
      "$ref": "#/$defs/candidateDecisionResult"
    }
  ],
  "$defs": {
    "program": {
    ...
    "projectedField": {
      ...
      "properties": {
        ...
        "kind": {
          "$ref": "#/$defs/projectedValueKind"
        },
        "value": {
          "$ref": "#/$defs/projectedScalar"
        },
        "source": {
    ...
    "documentResult": {
      ...
      "properties": {
        ...
        "sections": {
          ...
          "maxItems": 64,
          "items": {
            "$ref": "#/$defs/projectedSection"
          }
        },
        "validation": {
          "$ref": "#/$defs/documentValidation"
        },
        "unknownNodes": {
          "type": "array",
          "maxItems": 4096,
