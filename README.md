...
agent-native computational-chemistry console. Version `0.1.5` is the current
...
1. Open the private repository's
   ...
   page.
2. Download `ChemSmart-Studio-0.1.5-arm64.zip`.
...
- a guided Click-derived Console with semantic completion, deterministic
  preflight, decision-tree suggestions, coordinate drag-and-drop, and
  molecule/YAML tab opening;
- six explicit Agent workflows (`general`, `project-setup`, `command`,
  `molecule`, `calculation`, and `results`) with capability ceilings and
