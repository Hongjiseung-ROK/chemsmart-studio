...
agent-native computational-chemistry console. Version `0.1.0` is the first
...
1. Open the private repository's
   ...
   page.
2. Download `ChemSmart-Studio-0.1.0-arm64.zip`.
...
This is an internal research build, not a public production-ready release.
Protocol-v2 activation (P6) and integrated release acceptance (P7) remain open.
Do not use this version as the sole record for regulated, safety-critical, or
publication-final calculations.
