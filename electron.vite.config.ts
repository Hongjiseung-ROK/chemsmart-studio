...
const mainExternalModules = [
  ...
  'utf-8-validate',
  'electron',
  // Development-only and loaded lazily after Electron is ready. Keeping this
  // CommonJS package external avoids Rollup inlining a broken dynamic-import
  // interop helper into the single-file main bundle.
  ...
  main: {
    ...
    resolve: {
      alias: {
        ...
        '@chemsmart/studio-protocol': resolve('packages/studio-protocol/src'),
  ...
  renderer: {
    ...
    resolve: {
      alias: {
        ...
        '@shared': resolve('src/shared'),
        '@chemsmart/molecular-engine': resolve('packages/chem-molecular-engine/src'),
        '@chemsmart/studio-protocol': resolve('packages/studio-protocol/src'),
